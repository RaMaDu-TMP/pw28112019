    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <span class="table-add"><a href="#addModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicionar novo aluno</span></a></span>
                </div>
            </div>
        </div>
        <table class="table table-striped w-auto" id="table">
            ...
            <tbody>
            <%
                Collection<Aluno> alunos = AlunoDAO.getAll();
            ...
            <form action="actions/insert.jsp" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>RA</label>
                        <input type="number" class="form-control" id="add-ra" name="ra" required>
                        <label>Nome</label>
            ...
            <form action="actions/update.jsp" method="post">
                ...
                <div class="modal-body">
                    <div class="deleteModalform-group">
                        ...
                        <label>RA</label>
                        <input type="number" class="form-control" id="edit-ra" name="ra" required>
                        <label>Nome</label>

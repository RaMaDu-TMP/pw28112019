    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <span class="table-add"><a href="#addModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicionar novo curso</span></a></span>
                </div>
            </div>
        </div>
        <table class="table table-striped w-auto" id="table">
            ...
            <tbody>
            <%
                Collection<Curso> cursos = CursoDAO.getAll();

...
--
-- Host: localhost
-- Tempo de geração: 26/11/2019 às 03:03
...
INSERT INTO `disciplinas` (`id`, `nome`, `turno`, `dia_semana`, `curso_id`, `professor_id`) VALUES
(1, 'Química dos materiais', 'MATUTINO', 'SAB', 1, 1),
(2, 'Programação Orientada a Objetos', 'VESPERTINO', 'SEX', 5, 4),
(3, 'Programação Web', 'NOTURNO', 'TER', 5, 4);
